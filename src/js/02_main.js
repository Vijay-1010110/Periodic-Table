        ...
        <div class="legend-box-content" style="gap: 20px;">
            <div class="aufbau-diagram-container" style="margin: 0; align-items: flex-start; padding: 0;">
                <div class="aufbau-legend" style="margin-bottom: 0; gap: 6px;">
                    <div class="legend-item" data-key="s" data-type="block" style="background: rgba(0, 212, 255, 0.2); border: 1.5px solid #00d4ff; color: #00d4ff; font-weight: 700; border-radius: 6px; padding: 4px 10px; margin-bottom: 2px; box-shadow: 0 0 8px rgba(0, 212, 255, 0.3);">s-block</div>
                    <div class="legend-item" data-key="p" data-type="block" style="background: rgba(132, 204, 22, 0.2); border: 1.5px solid #84cc16; color: #84cc16; font-weight: 700; border-radius: 6px; padding: 4px 10px; margin-bottom: 2px; box-shadow: 0 0 8px rgba(132, 204, 22, 0.3);">p-block</div>
                    <div class="legend-item" data-key="d" data-type="block" style="background: rgba(217, 70, 239, 0.2); border: 1.5px solid #d946ef; color: #d946ef; font-weight: 700; border-radius: 6px; padding: 4px 10px; margin-bottom: 2px; box-shadow: 0 0 8px rgba(217, 70, 239, 0.3);">d-block</div>
                    <div class="legend-item" data-key="f" data-type="block" style="background: rgba(59, 130, 246, 0.2); border: 1.5px solid #3b82f6; color: #3b82f6; font-weight: 700; border-radius: 6px; padding: 4px 10px; margin-bottom: 2px; box-shadow: 0 0 8px rgba(59, 130, 246, 0.3);">f-block</div>
                    <div class="legend-item non-interactive" style="background: rgba(239, 68, 68, 0.15); border: 1px solid rgba(239, 68, 68, 0.5); border-radius: 6px; padding: 3px 8px; margin-top: 4px; display: flex; align-items: center; gap: 5px; font-size: 0.68rem; color: #f87171; cursor: default;">
                        <span style="color: #ef4444; font-weight: 900; font-size: 0.8rem; text-shadow: 0 0 6px rgba(239,68,68,0.8);">Sym</span> = Exception
                    </div>
                </div>
